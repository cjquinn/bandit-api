        ...
        <header>
            ...
            <dd class="player__id__stats">
                ...
                <?php
                    ...
                    <span class="player__id__result"><span class="points-won">Promoted</span> from Box 2</span>

                    <span class="player__id__result"><span class="points-loss">Demoted</span> from Box 1</span>

                    */

                ?>
                
                <span class="player__id__result"><b>#3</b> in Box 2</span>
            </dd>
