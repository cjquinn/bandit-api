                    ...
                    <section class="block">
                        ...
                        <ol class="stream is--players">
                            ...
                            <li class="player block__slab is--level50">
                                ...
                                <aside class="player__number h3">22<small class="h3__small">pts</small></aside>
                            ...
                            <li class="player block__slab is--level50">
                                ...
                                <dl class="player__id">
                                    ...
                                    <figure class="player__player-photo">
                                        <div class="player-photo__proportion">
                                            <svg class="player-photo__level__svg"><use class="player-photo__level__use" xlink:href="#player-level" /></svg>
                                            <img src="http://userphoto.localhost/get.php?id=45" alt="Photo 1" class="player-photo__image clip-hexagon" />
                                        </div>
                                    </figure>
