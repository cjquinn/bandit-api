                    ...
                    <section class="block">
                        ...
                        <ol class="stream is--matches">
                            ...
                            <li class="match block__slab is--draw gflex">
                                ...
                                <div class="match__player is--draw is--level48 col">
                                ...
                                <div class="match__player is--draw is--level49 col">
                        ...
                        <ol class="stream is--players">
                            ...
                            <li class="player block__slab">
                                ...
                                <dl class="player__id">
                                    ...
                                    <figure class="player__player-photo">
                                        <div class="player-photo__proportion">
                                            <svg class="player-photo__knot__svg"><use class="player-photo__knot__use" xlink:href="#brand-knot" /></svg>

                                            <svg class="player-photo__level__svg is--level100"><use class="player-photo__level__use is--level100" xlink:href="#player-level" /></svg>
                                            <svg class="player-photo__level__svg"><use class="player-photo__level__use is--level55" xlink:href="#player-level" /></svg>

                                            <img src="http://userphoto.localhost/get.php?id=31" alt="Photo 1" class="player-photo__image clip-hexagon" />
                                        </div>
                                    </figure>
                            ...
                            <li class="player block__slab">
                                ...
                                <dl class="player__id">
                                    ...
                                    <figure class="player__player-photo">
                                        <div class="player-photo__proportion">
                                            <svg class="player-photo__level__svg"><use class="player-photo__level__use is--level54" xlink:href="#player-level" /></svg>

                                            <img src="http://userphoto.localhost/get.php?id=60" alt="Photo 1" class="player-photo__image clip-hexagon" />
                                        </div>
                                    </figure>
